        ...
        <div>
          ...
          <form>
            <div className="flex flex-col items-start mb-4">
              ...
              <select
                id="options"
                className="block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-[#633CFF] focus:border-[#633CFF] sm:text-sm"
              >
